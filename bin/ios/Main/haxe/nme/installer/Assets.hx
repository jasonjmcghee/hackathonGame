...
class Assets {
	...
	private static function initialize ():Void {
		...
		if (!initialized) {
			...
			resourceNames.set ("gfx/preloader/haxepunk.png", "gfx_preloader_haxepunk_png");
			resourceTypes.set ("gfx/preloader/haxepunk.png", "image");
			resourceNames.set ("gfx/debug/console_debug.png", "gfx_debug_console_debug_png");
			resourceTypes.set ("gfx/debug/console_debug.png", "image");
			resourceNames.set ("gfx/debug/console_step.png", "gfx_debug_console_step_png");
			resourceTypes.set ("gfx/debug/console_step.png", "image");
			resourceNames.set ("gfx/debug/console_pause.png", "gfx_debug_console_pause_png");
			resourceTypes.set ("gfx/debug/console_pause.png", "image");
			resourceNames.set ("gfx/debug/console_play.png", "gfx_debug_console_play_png");
			resourceTypes.set ("gfx/debug/console_play.png", "image");
			resourceNames.set ("gfx/debug/console_logo.png", "gfx_debug_console_logo_png");
			resourceTypes.set ("gfx/debug/console_logo.png", "image");
			resourceNames.set ("gfx/debug/console_output.png", "gfx_debug_console_output_png");
