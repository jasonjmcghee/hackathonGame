...
ApplicationMain.main = function() {
	...
	ApplicationMain.loaders.set("gfx/lava.png",loader9);
	ApplicationMain.total++;
	var loader10 = new browser.display.Loader();
	ApplicationMain.loaders.set("gfx/floor.png",loader10);
	ApplicationMain.total++;
	var loader11 = new browser.display.Loader();
	ApplicationMain.loaders.set("gfx/wall.png",loader11);
	ApplicationMain.total++;
	if(ApplicationMain.total == 0) ApplicationMain.begin(); else {
		...
		while( $it0.hasNext() ) {
			...
			loader12.load(new browser.net.URLRequest(path));
		}
...
GameWorld.prototype = $extend(com.haxepunk.World.prototype,{
	...
	,begin: function() {
		...
		var _g1 = 0, _g = Math.floor(this.worldWidth);
		while(_g1 < _g) {
			var i = _g1++;
			var _g3 = 0, _g2 = Math.floor(this.worldHeight);
			while(_g3 < _g2) {
				var j = _g3++;
