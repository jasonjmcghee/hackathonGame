...
Void ApplicationMain_obj::main( ){
{
		...
		HX_STACK_LINE(15)
		::nme::Lib_obj::setPackage(HX_CSTRING(""),HX_CSTRING("Main"),HX_CSTRING("com.example.app"),HX_CSTRING("1.0.0"));
		...
		HX_STACK_LINE(39)
		::nme::Lib_obj::create( Dynamic(new _Function_1_1()),(int)640,(int)480,(int)30,(int)3355443,(int((int((int((int((int((int((int((int((int((int(::nme::Lib_obj::HARDWARE) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int(::nme::Lib_obj::RESIZABLE))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0))) | int((int)0)),HX_CSTRING("HackGame"),null());
	}
return null();
}
...
Dynamic ApplicationMain_obj::getAsset( ::String inName){
	...
	HX_STACK_LINE(107)
	if (((inName == HX_CSTRING("gfx/preloader/haxepunk.png")))){
		HX_STACK_LINE(108)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("gfx/preloader/haxepunk.png"),null());
	}
	HX_STACK_LINE(114)
	if (((inName == HX_CSTRING("gfx/debug/console_debug.png")))){
		HX_STACK_LINE(115)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("gfx/debug/console_debug.png"),null());
	}
	HX_STACK_LINE(121)
	if (((inName == HX_CSTRING("gfx/debug/console_step.png")))){
		HX_STACK_LINE(122)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("gfx/debug/console_step.png"),null());
	}
	HX_STACK_LINE(128)
	if (((inName == HX_CSTRING("gfx/debug/console_pause.png")))){
		HX_STACK_LINE(129)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("gfx/debug/console_pause.png"),null());
	}
	HX_STACK_LINE(135)
	if (((inName == HX_CSTRING("gfx/debug/console_play.png")))){
		HX_STACK_LINE(136)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("gfx/debug/console_play.png"),null());
	}
	HX_STACK_LINE(142)
	if (((inName == HX_CSTRING("gfx/debug/console_logo.png")))){
		HX_STACK_LINE(143)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("gfx/debug/console_logo.png"),null());
	}
	HX_STACK_LINE(149)
	if (((inName == HX_CSTRING("gfx/debug/console_output.png")))){
		HX_STACK_LINE(150)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("gfx/debug/console_output.png"),null());
	}
	HX_STACK_LINE(156)
	if (((inName == HX_CSTRING("font/04B_03__.ttf")))){
		HX_STACK_LINE(157)
		return ::nme::installer::Assets_obj::getFont(HX_CSTRING("font/04B_03__.ttf"));
	}
	HX_STACK_LINE(163)
	if (((inName == HX_CSTRING("gfx/tileset.png")))){
		HX_STACK_LINE(164)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("gfx/tileset.png"),null());
	}
	HX_STACK_LINE(170)
	if (((inName == HX_CSTRING("gfx/block.png")))){
		HX_STACK_LINE(171)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("gfx/block.png"),null());
	}
	HX_STACK_LINE(177)
	if (((inName == HX_CSTRING("gfx/floor.png")))){
		HX_STACK_LINE(178)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("gfx/floor.png"),null());
	}
	HX_STACK_LINE(184)
	if (((inName == HX_CSTRING("gfx/wall.png")))){
		HX_STACK_LINE(185)
		return ::nme::installer::Assets_obj::getBitmapData(HX_CSTRING("gfx/wall.png"),null());
	}
	HX_STACK_LINE(191)
	if (((inName == HX_CSTRING("font/04B_03__.ttf")))){
		HX_STACK_LINE(192)
